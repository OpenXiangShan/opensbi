...
carray-fdt_serial_drivers-$(CONFIG_FDT_SERIAL_VIRTIO_CONSOLE) += fdt_serial_virtio_console
libsbiutils-objs-$(CONFIG_FDT_SERIAL_VIRTIO_CONSOLE) += serial/fdt_serial_virtio_console.o
...
libsbiutils-objs-$(CONFIG_SERIAL_VIRTIO_CONSOLE) += serial/virtio_console.o
